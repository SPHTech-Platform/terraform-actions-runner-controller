...
variable "controller_manager_addr" {
  description = "Set the Addr/Port of the Controller Manager"
  type        = string
  default     = ":8080"
}

variable "listener_addr" {
  description = "Set the Addr/Port of the Listener"
  type        = string
  default     = ":8080"
}
